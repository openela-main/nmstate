...
- Upgrade to 2.2.57
- Use global DNS even for static IP with static DNS. (RHEL-126738)
- Add libreswan leftprotoport and rightprotoport support. (RHEL-130914)
...
- Upgrade to 2.2.52
- Support interface alternative names. RHEL-110636
- Support IPv4 forwarding. RHEL-110789
- Support IPSec `leftsendcert` option. RHEL-110636
