...
* Fri Sep 04 2026 Rahul Rajesh <rrajesh@redhat.com> - 2.2.60-3
- Ignore IP addresses with non-kernel IFA_PROTO RHEL-253627

* Wed May 06 2026 Íñigo Huguet <ihuguet@redhat.com> - 2.2.60-2
- Fix infiniband devices

* Thu Apr 23 2026 Jan Vaclav <jvaclav@redhat.com> - 2.2.60-1
- Upgrade to 2.2.60
- ipv4: Add new parameter prefix-route-metric RHEL-170697

* Fri Mar 06 2026 Rahul Rajesh <rrajesh@redhat.com> - 2.2.59-1
- Upgrade to 2.2.59
- Add support for lock-mtu option. RHEL-151937

* Wed Feb 11 2026 Mingyu Shi <mshi@redhat.com> - 2.2.58-1
- Upgrade to 2.2.58
- vrf: Handle ignore interface when verifying desired state. RHEL-1417
- alt-name: Remove alt-names when interface marked as absent. RHEL-126481
- hsr: Automatically disable IP on hsr port. RHEL-100774
- hsr: add support for configuring "interlink" property. RHEL-100766
- Support referring alternative-name as port/parent/next-hop-interface.
  RHEL-126508
- Support referring interface name using its alternative name. RHEL-126510

* Tue Dec 09 2025 Gris Ge <fge@redhat.com> - 2.2.57-1
- Upgrade to 2.2.57
- Add libreswan leftprotoport and rightprotoport support. (RHEL-107158)
- Support setting protocol version of HSR/PRP. (RHEL-100763)
- Fix inconsistent interface order. (RHEL-130157)
...
- Applying desired state with static DNS with static IP will touch `br-ex`
  even not mentioned. RHEL-125548
...
- Upgrade to 2.2.54
- Fix OVSDB query failure on database bigger than 20KiB. RHEL-121418
...
* Tue Aug 05 2025 Rahul Rajesh <rrajesh@redhat.com> - 2.2.49-1
- Upgrade to 2.2.49
...
- Upgrade to 2.2.48
- Validate OVN bridge mapping. RHEL-37922
- Support bond `lacp_active` and `ns_ip6_target`. RHEL-1415
- Support matching by PCI adress. RHEL-80116
- Apply dispatch changes first. RHEL-94840
- Fix SRIOV VF reference. RHEL-91588
- Fix deleting with `fail_over_mac` bond. RHEL-102600
...
- Upgrade to 2.2.45
- Fix stuck on `nmstatectl show`. RHEL-93154
...
* Fri Mar 07 2025 Mingyu Shi <mshi@redhat.com> - 2.2.42-2
- Enable gating test in tmt
